/*** لا تقم بإزالة هذه العلامة المائية.*
* NIXCODE - أداة متقدمة لإنشاء الرسائل التفاعلية على واتساب
* مصمم لإنشاء الأزرار، والشرائح الدوارة، والتدفقات الأصلية،
* وحمولات الاستجابة الغنية بالذكاء الاصطناعي باستخدام Baileys مع
* الربط السلس، وتخصيص الحمولة المرن،
* وبنية قابلة للتطوير لتطوير الروبوتات الحديثة.*
* وقت التشغيل:
...
*
* يُسمح باستخدام هذه المكتبة وتعديلها 
* للمشاريع الشخصية أو التجارية. 
*
* إعادة التحميل، أو إعادة البيع، أو إعادة الترخيص، أو إعادة التوزيع
* يُحظر استخدام هذه المكتبة كمنتج مستقل.
*
* لا تدّعي أن هذا المشروع هو عملك الأصلي.
*/
...
// 🛡️ لو الـ Buffer فاضي، نرجع فاضي فوراً عشان sharp ميصرخش
...
// 🛡️ لو الصورة تالفة أو الرابط رجع HTML، نرجع Buffer فاضي عشان البوت ميوقعش
...
...options,
headers: {
// 🛡️ إضافة User-Agent عشان نتجنب حظر المواقع للطلبات
